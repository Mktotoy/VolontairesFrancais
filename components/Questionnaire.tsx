...
export const QUESTIONS: Question[] = [
    ...
    },
    {
        ...
        options: [
            ...
            "Village olympique",
            "Chauffeur",
            "Game family Assistant",
            "Accréditations / Uniformes",
            "Media Center",
            "Autres",
        ],
        required: true,
    },
    {
        ...
        condition: (a) =>
            a.sites_zones?.includes("MILAN") &&
            a.milan_venues?.includes("Autres"),
        required: true,
    },
    {
        id: "cortina_venues",
    ...
    },
    {
        ...
        condition: (a) =>
            a.sites_zones?.includes("CORTINA D’AMPEZZO") &&
            a.cortina_venues?.includes("Autres"),
        required: true,
    },
    {
        id: "verona_venues",
    ...
    },
    {
        ...
        condition: (a) =>
            a.sites_zones?.includes("VERONA") &&
            a.verona_venues?.includes("Autres"),
        required: true,
    },
    {
        id: "fiemme_venues",
    ...
    },
    {
        ...
        condition: (a) =>
            a.sites_zones?.includes("VAL DI FIEMME") &&
            a.fiemme_venues?.includes("Autres"),
        required: true,
    },
    {
    ...
    },
    {
        ...
        condition: (a) =>
            a.sites_zones?.includes("VALTELLINA") &&
            a.valtellina_venues?.includes("Autres"),
        required: true,
    },
    {
    ...
    },
    {
        ...
        condition: (a) =>
            a.sites_zones?.includes("ANTERSELVA") &&
            a.anterselva_venues?.includes("Autres"),
        required: true,
    },
    {
    ...
    },
    {
        ...
        description:
            "1 = Pas du tout acceptable | 5 = Neutre | 10 = Très acceptable",
        min: 1,
        max: 10,
        step: 1,
        required: true,
    },
    {
        ...
        description:
            "1 = Pas du tout satisfait(e) | 5 = Neutre | 10 = Très satisfait(e)",
        min: 1,
        max: 10,
        step: 1,
        required: true,
    },
    {
        ...
        description:
            "1 = Pas du tout importantes | 5 = Neutre | 10 = Très importantes",
        min: 1,
        max: 10,
        step: 1,
        required: true,
    },
    {
        ...
        description:
            "1 = Pas du tout importante | 5 = Neutre | 10 = Très importante",
        min: 1,
        max: 10,
        step: 1,
        required: true,
    ...
    },
    {
        ...
        description:
            "1 = Pas du tout importants | 5 = Neutre | 10 = Très importants",
        min: 1,
        max: 10,
        step: 1,
        required: true,
    },
    {
        ...
        options: [
            ...
            "Octobre 2025",
            "Novembre 2025",
            "1er au 15 décembre 2025",
            "16 au 31 décembre 2025",
            "1er au 15 janvier 2026",
            "16 au 31 janvier 2026",
            "Février 2026",
    ...
    },
    {
        ...
        condition: (a) =>
            a.recevoir_resultats === "Oui" || a.rejoindre_association === "Oui",
        required: false,
    },
    {
        id: "merci",
        ...
        description:
            "Cliquez sur envoyer pour transmettre vos réponses. Bon retour et bon repos !",
    },
];
