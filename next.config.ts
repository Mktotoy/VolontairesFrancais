    ...
    return {
      beforeFiles: [
        ...
        },
        {
          ...
          destination: 'https://admin.volontairesfrancais.fr/permissions/:path*',
        },
        {
          source: '/collections/:path*',
          destination: 'https://admin.volontairesfrancais.fr/collections/:path*',
        },
        {
          source: '/fields/:path*',
        ...
        },
        {
          ...
          destination: 'https://admin.volontairesfrancais.fr/translations/:path*',
        },
        {
        ...
        },
        {
          ...
          destination: 'https://admin.volontairesfrancais.fr/notifications/:path*',
        },
