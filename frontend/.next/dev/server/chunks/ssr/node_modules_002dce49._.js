...
"[project]/node_modules/@directus/sdk/dist/rest/utils/get-auth-endpoint.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
 //# sourceMappingURL=get-auth-endpoint.js.map
}),
"[project]/node_modules/@directus/sdk/dist/auth/utils/memory-storage.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/utils/query-to-params.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const e = (e)=>{
    let t = (e, n = [])=>{
        if (typeof e == `object`) {
            ...
            for(let i in e){
                let a = e[i] ?? [];
                if (Array.isArray(a)) for (let e of a)r.push(t(e, [
                    ...n,
                    i
                ]));
                else if (typeof a == `object`) for (let e of Object.keys(a)){
                    let o = a[e];
                    for (let a of o)r.push(t(a, [
                        ...n,
                        `${i}:${e}`
                    ]));
                }
    ...
    `version`,
    `versionRaw`
], n = (e)=>typeof e == `boolean`, r = (e)=>typeof e == `string` && !!e, i = (e)=>typeof e == `number`, a = (e)=>Array.isArray(e) && e.length > 0, o = (e)=>typeof e == `object` && !!e && !a(e) && Object.keys(e).length > 0, s = (s)=>{
    let c = {};
    s.fields && (a(s.fields) && (c.fields = e(s.fields).join(`,`)), r(s.fields) && (c.fields = s.fields)), o(s.filter) && (c.filter = JSON.stringify(s.filter)), r(s.search) && (c.search = s.search), s.sort && (a(s.sort) && (c.sort = s.sort.join(`,`)), r(s.sort) && (c.sort = s.sort)), `limit` in s && (i(s.limit) && s.limit >= -1 && (c.limit = String(s.limit)), r(s.limit) && (c.limit = s.limit)), `offset` in s && (i(s.offset) && s.offset >= 0 && (c.offset = String(s.offset)), r(s.offset) && (c.offset = s.offset)), `page` in s && (i(s.page) && s.page >= 1 && (c.page = String(s.page)), r(s.page) && (c.page = s.page)), o(s.deep) && (c.deep = JSON.stringify(s.deep)), o(s.alias) && (c.alias = JSON.stringify(s.alias)), o(s.aggregate) && (c.aggregate = JSON.stringify(s.aggregate)), s.groupBy && (a(s.groupBy) && (c.groupBy = s.groupBy.join(`,`)), r(s.groupBy) && (c.groupBy = s.groupBy)), r(s.version) && (c.version = s.version), s.versionRaw && (n(s.versionRaw) && (c.versionRaw = String(s.versionRaw)), r(s.versionRaw) && (c.versionRaw = s.versionRaw));
    for (let [e, n] of Object.entries(s)){
        if (t.includes(e)) continue;
        let r;
        r = typeof n == `string` ? n : JSON.stringify(n), r && (c[e] = r);
    }
    return c;
};
;
...
"[project]/node_modules/@directus/sdk/dist/utils/get-request-url.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$query$2d$to$2d$params$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/query-to-params.js [app-rsc] (ecmascript)");
...
;
;
const t = (e, t)=>(e.endsWith(`/`) && (e = e.slice(0, -1)), t.startsWith(`/`) || (t = `/` + t), e + t), n = (n, r, i)=>{
    let a = n.pathname === `/` ? r : t(n.pathname, r), o = new globalThis.URL(a, n);
    if (i) for (let [t, n] of Object.entries((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$query$2d$to$2d$params$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["queryToParams"])(i)))if (n && typeof n == `object` && !Array.isArray(n)) for (let [e, r] of Object.entries(n))o.searchParams.set(`${t}[${e}]`, String(r));
    else o.searchParams.set(t, n);
    return o;
};
;
 //# sourceMappingURL=get-request-url.js.map
}),
"[project]/node_modules/@directus/sdk/dist/utils/is-response.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
 //# sourceMappingURL=is-response.js.map
}),
"[project]/node_modules/@directus/sdk/dist/utils/extract-data.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$is$2d$response$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/utils/is-response.js [app-rsc] (ecmascript)");
;
async function t(t) {
    if (!(typeof t != `object` || !t)) {
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$is$2d$response$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isFetchResponse"])(t)) {
            let e = t.headers.get(`Content-Type`)?.toLowerCase();
            if (e?.startsWith(`application/json`) || e?.startsWith(`application/health+json`)) {
                let e = await t.json();
                if (!t.ok || `errors` in e) throw e;
                return `data` in e ? e.data : e;
            }
            if (e?.startsWith(`text/html`) || e?.startsWith(`text/plain`)) {
                let e = await t.text();
                if (!t.ok) throw e;
                return e;
            }
...
"[project]/node_modules/@directus/sdk/dist/utils/request.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$extract$2d$data$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/utils/extract-data.js [app-rsc] (ecmascript)");
;
const t = async (t, n, r = globalThis.fetch)=>(n.headers = typeof n.headers == `object` && !Array.isArray(n.headers) ? n.headers : {}, r(t, n).then((t)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$extract$2d$data$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["extractData"])(t).catch((e)=>{
            let n = {
                message: ``,
                errors: e && typeof e == `object` && `errors` in e ? e.errors : e,
                response: t
            };
            return e && typeof e == `object` && `data` in e && (n.data = e.data), Array.isArray(n.errors) && n.errors[0]?.message && (n.message = n.errors[0].message), Promise.reject(n);
        })));
;
 //# sourceMappingURL=request.js.map
}),
"[project]/node_modules/@directus/sdk/dist/auth/composable.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$get$2d$auth$2d$endpoint$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/get-auth-endpoint.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$get$2d$request$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/utils/get-request-url.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$request$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/utils/request.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$auth$2f$utils$2f$memory$2d$storage$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/auth/utils/memory-storage.js [app-rsc] (ecmascript)");
;
;
;
;
const i = {
    ...
    autoRefresh: !0
}, a = 2 ** 31 - 1, o = (o = `cookie`, s = {})=>(c)=>{
        let l = {
            ...i,
            ...s
        }, u = null, d = null, f = l.storage ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$auth$2f$utils$2f$memory$2d$storage$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["memoryStorage"])(), p = async ()=>f.set({
                access_token: null,
                refresh_token: null,
                expires: null,
                expires_at: null
            ...
            let e = await f.get();
            return u || !e?.expires_at || e.expires_at < new Date().getTime() + l.msRefreshBeforeExpires && _().catch((e)=>{}), m();
        }, g = async (e)=>{
            let t = e.expires ?? 0;
            e.expires_at = new Date().getTime() + t, await f.set(e), l.autoRefresh && t > l.msRefreshBeforeExpires && t < a && (d && clearTimeout(d), d = setTimeout(()=>{
                d = null, _().catch((e)=>{});
            }, t - l.msRefreshBeforeExpires));
        }, _ = async (e = {})=>(u = (async ()=>{
                let r = await f.get(), i = {
                    method: `POST`,
                    headers: {
                ...
                `credentials` in l && (i.credentials = l.credentials);
                let a = {
                    mode: e.mode ?? o
                };
                o === `json` && r?.refresh_token && (a.refresh_token = r.refresh_token), i.body = JSON.stringify(a);
                let s = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$request$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["request"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$get$2d$request$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRequestUrl"])(c.url, `/auth/refresh`).toString(), i, c.globals.fetch);
                return await p(), await g(s), s;
            })(), u);
        async function v(r, i = {}) {
            let a = r;
            `otp` in i && (a.otp = i.otp), a.mode = i.mode ?? o;
            let s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$get$2d$auth$2d$endpoint$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAuthEndpoint"])(i.provider), u = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$get$2d$request$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRequestUrl"])(c.url, s), d = {
                method: `POST`,
                headers: {
                    "Content-Type": `application/json`
                },
            ...
            `credentials` in l && (d.credentials = l.credentials);
            let f = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$request$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["request"])(u.toString(), d, c.globals.fetch);
            return await p(), await g(f), f;
        }
        return {
            refresh: _,
            login: v,
            async logout (e = {}) {
                ...
                o === `json` && r?.refresh_token && (a.refresh_token = r.refresh_token), i.body = JSON.stringify(a), await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$request$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["request"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$get$2d$request$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRequestUrl"])(c.url, `/auth/logout`).toString(), i, c.globals.fetch), this.stopRefreshing(), await p();
            },
            stopRefreshing () {
                d && clearTimeout(d);
            },
            async getToken () {
                return await h().catch(()=>{}), (await f.get())?.access_token ?? null;
            },
            async setToken (e) {
                return f.set({
                    access_token: e,
...
"[project]/node_modules/@directus/sdk/dist/auth/static.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/auth/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$auth$2f$utils$2f$memory$2d$storage$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/auth/utils/memory-storage.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$auth$2f$composable$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/auth/composable.js [app-rsc] (ecmascript)");
...
"[project]/node_modules/@directus/sdk/dist/client.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/graphql/composable.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const n = {}, r = (r = {})=>(i)=>{
        ...
        return {
            async query (n, r, o = `items`) {
                ...
                `credentials` in a && (s.credentials = a.credentials);
                let c = {};
                if (`getToken` in this) {
                    let e = await this.getToken();
                    e && (c.Authorization = `Bearer ${e}`);
                }
                `Content-Type` in c || (c[`Content-Type`] = `application/json`), s.headers = c;
                let l = o === `items` ? `/graphql` : `/graphql/system`;
                return await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$request$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["request"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$get$2d$request$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRequestUrl"])(i.url, l).toString(), s, i.globals.fetch);
            }
        };
    };
;
...
"[project]/node_modules/@directus/sdk/dist/graphql/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$graphql$2f$composable$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/graphql/composable.js [app-rsc] (ecmascript)");
;
;
}),
"[project]/node_modules/@directus/sdk/dist/realtime/commands/auth.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/realtime/commands/pong.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/realtime/utils/generate-uid.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/realtime/utils/message-callback.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const e = (e, t = 1e3)=>new Promise((n, r)=>{
        let i = (e)=>{
            try {
                let t = JSON.parse(e.data);
                typeof t == `object` && !Array.isArray(t) && t !== null ? (o(), n(t)) : (o(), a());
            } catch  {
                o(), n(e);
            }
        }, a = ()=>r(), o = ()=>{
            clearTimeout(s), e.removeEventListener(`message`, i), e.removeEventListener(`error`, a), e.removeEventListener(`close`, a);
        };
        e.addEventListener(`message`, i), e.addEventListener(`error`, a), e.addEventListener(`close`, a);
        let s = setTimeout(()=>{
            o(), n(void 0);
        }, t);
    });
...
"[project]/node_modules/@directus/sdk/dist/realtime/composable.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$commands$2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/commands/auth.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$commands$2f$pong$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/commands/pong.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$generate$2d$uid$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/utils/generate-uid.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$message$2d$callback$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/utils/message-callback.js [app-rsc] (ecmascript)");
;
;
;
;
...
function a(a1 = {}) {
    return (o)=>{
        ...
        let s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$generate$2d$uid$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateUid"])(), c = {
            code: `closed`
        }, l = {
            attempts: 0,
            active: !1
        }, u = !1, d = new Set, f = (e)=>`getToken` in e, p = (e, ...t)=>a1.debug && o.globals.logger[e](`[Directus SDK]`, ...t), m = async (e, t)=>{
            let n = new o.globals.URL(e);
            if (a1.authMode === `strict` && f(t)) {
                let e = await t.getToken();
                e && n.searchParams.set(`access_token`, e);
            }
            return n.toString();
        }, h = async (e)=>{
            if (`url` in a1) return await m(a1.url, e);
            if ([
                `ws:`,
                `wss:`
            ].includes(o.url.protocol)) return await m(o.url, e);
            let t = new o.globals.URL(o.url.toString());
            return t.protocol = o.url.protocol === `https:` ? `wss:` : `ws:`, t.pathname = `/websocket`, await m(t, e);
        }, g = (e)=>{
            let t = new Promise((t, n)=>{
                if (!a1.reconnect || u) return n();
                if (p(`info`, `reconnect #${l.attempts} ` + (l.attempts >= a1.reconnect.retries ? `maximum retries reached` : `trying again in ${Math.max(100, a1.reconnect.delay)}ms`)), l.active) return l.active;
                if (l.attempts >= a1.reconnect.retries) return l.attempts = -1, n();
                setTimeout(()=>e.connect().then((t)=>(d.forEach((t)=>{
                            e.sendMessage(t);
                        }), t)).then(t).catch(n), Math.max(100, a1.reconnect.delay));
            });
            l.attempts += 1, l.active = t.catch(()=>{}).finally(()=>{
                l.active = !1;
            });
        }, _ = {
            open: new Set([]),
        ...
        function v(e) {
            return `type` in e && `status` in e && `error` in e && `code` in e.error && `message` in e.error && e.type === `auth` && e.status === `error`;
        }
        async function y(t, n) {
            if (c.code === `open`) {
                if (t.error.code === `TOKEN_EXPIRED` && (p(`warn`, `Authentication token expired!`), f(n))) {
                    let t = await n.getToken();
                    if (!t) throw Error(`No token for re-authenticating the websocket`);
                    c.connection.send((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$commands$2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["auth"])({
                        access_token: t
                    }));
                }
                if (t.error.code === `AUTH_TIMEOUT`) return c.firstMessage && a1.authMode === `public` ? (p(`warn`, `Authentication failed! Currently the "authMode" is "public" try using "handshake" instead`), a1.reconnect = !1) : p(`warn`, `Authentication timed out!`), c.connection.close();
                if (t.error.code === `AUTH_FAILED`) {
                    if (c.firstMessage && a1.authMode === `public`) return p(`warn`, `Authentication failed! Currently the "authMode" is "public" try using "handshake" instead`), a1.reconnect = !1, c.connection.close();
                    p(`warn`, `Authentication failed!`);
                }
            }
        }
        let b = async (e)=>{
            for(; c.code === `open`;){
                let n = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$message$2d$callback$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["messageCallback"])(c.connection).catch(()=>{});
                if (n) {
                    if (v(n)) {
                        await y(n, e), c.firstMessage = !1;
                        continue;
                    }
                    if (a1.heartbeat && n.type === `ping`) {
                        c.connection.send((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$commands$2f$pong$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["pong"])()), c.firstMessage = !1;
                        continue;
                    }
                    _.message.forEach((e)=>{
                        c.code === `open` && e.call(c.connection, n);
                    }), c.firstMessage = !1;
                }
            }
        };
        return {
            async connect () {
                if (u = !1, c.code === `connecting`) return await c.connection;
                if (c.code !== `closed`) throw Error(`Cannot connect when state is "${c.code}"`);
                let t = this, i = await h(t);
                p(`info`, `Connecting to ${i}...`);
                let d = new Promise((u, d)=>{
                    let m = !1, h = new o.globals.WebSocket(i), v;
                    a1.connect && (v = setTimeout(()=>{
                        d(`Connection attempt timed out.`);
                    }, a1.connect.timeout ?? 1e4)), h.addEventListener(`open`, async (n)=>{
                        if (p(`info`, `Connection open.`), c = {
                            code: `open`,
                            connection: h,
                            firstMessage: !0
                        }, l.attempts = 0, l.active = !1, clearTimeout(v), b(t), a1.authMode === `handshake` && f(t)) {
                            let n = await t.getToken();
                            if (!n) return d(`No token for authenticating the websocket. Make sure to provide one or call the login() function beforehand.`);
                            h.send((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$commands$2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["auth"])({
                                access_token: n
                            }));
                            let i = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$message$2d$callback$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["messageCallback"])(h);
                            if (i && `type` in i && `status` in i && i.type === `auth` && i.status === `ok`) p(`info`, `Authentication successful!`);
                            else return d(`Authentication failed while opening websocket connection`);
                        }
                        _.open.forEach((e)=>e.call(h, n)), m = !0, u(h);
                    }), h.addEventListener(`error`, (e)=>{
                        p(`warn`, `Connection errored.`), _.error.forEach((t)=>t.call(h, e)), h.close(), c = {
                            code: `error`
                        }, m || d(e);
                    }), h.addEventListener(`close`, (e)=>{
                        p(`info`, `Connection closed.`), _.close.forEach((t)=>t.call(h, e)), s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$generate$2d$uid$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateUid"])(), c = {
                            code: `closed`
                        }, g(this), m || d(e);
                    });
                });
            ...
            disconnect () {
                u = !0, c.code === `open` && c.connection.close();
            },
            onWebSocket (e, t) {
                if (e === `message`) {
                    let n = function(e) {
                        if (typeof e.data != `string`) return t.call(this, e);
                        try {
                            return t.call(this, JSON.parse(e.data));
                        } catch  {
                            return t.call(this, e);
                        }
                    };
                    return _[e].add(n), ()=>_[e].delete(n);
                }
                return _[e].add(t), ()=>_[e].delete(t);
            },
            sendMessage (e) {
                if (c.code !== `open`) throw Error(`Cannot send messages without an open connection. Make sure you are calling "await client.connect()".`);
                if (typeof e == `string`) return c.connection.send(e);
                `uid` in e || (e.uid = s.next().value), c.connection.send(JSON.stringify(e));
            },
            async subscribe (e, t = {}) {
                `uid` in t || (t.uid = s.next().value), d.add({
                    ...t,
                    collection: e,
                    type: `subscribe`
                }), c.code !== `open` && (p(`info`, `No connection available for subscribing!`), await this.connect()), this.sendMessage({
                    ...t,
                    collection: e,
                    type: `subscribe`
                });
                ...
                async function* i() {
                    for(; n && c.code === `open`;){
                        let e = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$message$2d$callback$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["messageCallback"])(c.connection).catch(()=>{});
                        if (e) {
                            if (`type` in e && `status` in e && e.type === `subscribe` && e.status === `error`) throw e;
                            `type` in e && `uid` in e && e.type === `subscription` && e.uid === t.uid && (yield e);
                        }
                    }
                    a1.reconnect && l.active && (await l.active, c.code === `open` && (c.connection.send(JSON.stringify({
                        ...t,
                        collection: e,
                        type: `subscribe`
                    })), yield* i()));
...
"[project]/node_modules/@directus/sdk/dist/realtime/utils/sleep.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/auth/login.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function t(t1, n = {}) {
    return ()=>{
        let r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$get$2d$auth$2d$endpoint$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAuthEndpoint"])(n.provider), i = t1;
        return `otp` in n && (i.otp = n.otp), i.mode = n.mode ?? `cookie`, {
            path: r,
            method: `POST`,
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/auth/logout.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/auth/password-request.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/auth/password-reset.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/auth/providers.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/auth/refresh.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/collections.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/comments.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/dashboards.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/fields.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/files.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/flows.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/folders.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/utils/is-system-collection.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/items.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$is$2d$system$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/is-system-collection.js [app-rsc] (ecmascript)");
;
const t = (t, n, r)=>()=>{
        let i = String(t);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$is$2d$system$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isSystemCollection"])(i)) throw Error(`Cannot use createItems for core collections`);
        return {
            path: `/items/${i}`,
            params: r ?? {},
        ...
        let i = String(t);
        if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$is$2d$system$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isSystemCollection"])(i)) throw Error(`Cannot use createItem for core collections`);
        return {
            path: `/items/${i}`,
            params: r ?? {},
            body: JSON.stringify(n),
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/notifications.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/operations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/panels.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/permissions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/policies.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/presets.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/relations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/roles.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/shares.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/translations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/users.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/versions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/create/webhooks.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/collections.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const e = (e, t)=>{
    if (e.length === 0) throw Error(t);
};
;
 //# sourceMappingURL=throw-if-empty.js.map
}),
"[project]/node_modules/@directus/sdk/dist/rest/utils/throw-core-collection.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const t = (t, n)=>{
    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$is$2d$system$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isSystemCollection"])(String(t))) throw Error(n);
};
;
 //# sourceMappingURL=throw-core-collection.js.map
}),
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/comments.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t)=>()=>{
        let n = {};
        return Array.isArray(t) ? ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `keysOrQuery cannot be empty`), n = {
            keys: t
        }) : ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(Object.keys(t), `keysOrQuery cannot be empty`), n = {
            query: t
        }), {
            path: `/comments`,
            body: JSON.stringify(n),
    ...
    }, n = (t)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(t), `Key cannot be empty`), {
            path: `/comments/${t}`,
            method: `DELETE`
        });
;
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/dashboards.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Keys cannot be empty`), {
            path: `/dashboards`,
            body: JSON.stringify(t),
            method: `DELETE`
        }), n = (t)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Key cannot be empty`), {
            path: `/dashboards/${t}`,
            method: `DELETE`
        });
;
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/fields.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t, n)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(n, `Field cannot be empty`), {
            path: `/fields/${t}/${n}`,
            method: `DELETE`
        });
;
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/files.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/flows.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/folders.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/items.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-core-collection.js [app-rsc] (ecmascript)");
;
;
const n = (n, r)=>()=>{
        let i = {};
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use deleteItems for core collections`), Array.isArray(r) ? ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(r, `keysOrQuery cannot be empty`), i = {
            keys: r
        }) : ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(Object.keys(r), `keysOrQuery cannot be empty`), i = {
            query: r
        }), {
            path: `/items/${n}`,
            body: JSON.stringify(i),
    ...
    }, r = (n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use deleteItem for core collections`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(r), `Key cannot be empty`), {
            path: `/items/${n}/${r}`,
            method: `DELETE`
        });
;
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/notifications.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = (t)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Keys cannot be empty`), {
            ...
            path: `/notifications/${t}`,
            method: `DELETE`
        });
;
 //# sourceMappingURL=notifications.js.map
}),
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/operations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/panels.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/permissions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/policies.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/presets.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/relations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/roles.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/shares.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/translations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/users.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/versions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/delete/webhooks.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/activity.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = (e)=>()=>({
            ...
            params: e ?? {},
            method: `GET`
        }), n = (t, n)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(t), `Key cannot be empty`), {
            path: `/activity/${t}`,
            params: n ?? {},
            method: `GET`
        });
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/aggregate.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const n = (n, r)=>()=>{
        let i = String(n);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(i, `Collection cannot be empty`), {
            path: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$is$2d$system$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["isSystemCollection"])(i) ? `/${i.substring(9)}` : `/items/${i}`,
            method: `GET`,
            params: {
                ...r.query ?? {},
                ...r.groupBy ? {
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/assets.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t, n)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(t), `Key cannot be empty`), {
            path: `/assets/${t}`,
            params: n ?? {},
            method: `GET`,
            onResponse: (e)=>e.body
            ...
            method: `GET`,
            onResponse: (e)=>e.blob()
        }), r = (t, n)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(t), `Key cannot be empty`), {
            path: `/assets/${t}`,
            params: n ?? {},
            method: `GET`,
            onResponse: (e)=>e.arrayBuffer()
        });
;
 //# sourceMappingURL=assets.js.map
}),
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/collections.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = ()=>()=>({
            path: `/collections`,
            method: `GET`
        }), n = (t)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Collection cannot be empty`), {
            path: `/collections/${t}`,
            method: `GET`
        });
;
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/comments.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/dashboards.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/extensions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/fields.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = ()=>()=>({
            ...
            path: `/fields/${t}`,
            method: `GET`
        }), r = (t, n)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(n, `Field cannot be empty`), {
            path: `/fields/${t}/${n}`,
            method: `GET`
        });
;
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/files.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/flows.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/folders.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/items.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const n = (n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use readItems for core collections`), {
            path: `/items/${n}`,
            params: r ?? {},
            method: `GET`
        }), r = (n, r, i)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use readItem for core collections`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(r), `Key cannot be empty`), {
            path: `/items/${n}/${r}`,
            params: i ?? {},
            method: `GET`
        });
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/notifications.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/operations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/panels.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/permissions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = (e)=>()=>({
            ...
            params: n ?? {},
            method: `GET`
        }), r = (t, n)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(t), `Collection cannot be empty`), {
            path: `/permissions/me/${n ? `${t}/${n}` : `${t}`}`,
            method: `GET`
        }), i = ()=>()=>({
            path: `/permissions/me`,
            method: `GET`
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/policies.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/presets.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/relations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/revisions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/roles.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/settings.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/shares.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/singleton.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const n = (n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use readSingleton for core collections`), {
            path: `/items/${n}`,
            params: r ?? {},
            method: `GET`
        });
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/translations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/users.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/versions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/webhooks.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/schema/apply.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/schema/diff.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/schema/snapshot.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/server/graphql.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/server/health.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/server/info.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/server/openapi.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/server/ping.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/collections.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Collection cannot be empty`), {
            path: `/collections/${t}`,
            params: r ?? {},
            body: JSON.stringify(n),
            method: `PATCH`
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/comments.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = (t, n, r)=>()=>{
        let i = {};
        return Array.isArray(t) ? ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `keysOrQuery cannot be empty`), i = {
            keys: t
        }) : ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(Object.keys(t), `keysOrQuery cannot be empty`), i = {
            query: t
        }), i.data = n, {
            path: `/comments`,
            params: r ?? {},
            ...
            body: JSON.stringify(e),
            method: `PATCH`
        }), r = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(t), `Key cannot be empty`), {
            path: `/comments/${t}`,
            params: r ?? {},
            body: JSON.stringify(n),
            method: `PATCH`
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/dashboards.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Keys cannot be empty`), {
            path: `/dashboards`,
            params: r ?? {},
            body: JSON.stringify({
                keys: t,
            ...
            body: JSON.stringify(e),
            method: `PATCH`
        }), r = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Key cannot be empty`), {
            path: `/dashboards/${t}`,
            params: r ?? {},
            body: JSON.stringify(n),
            method: `PATCH`
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/extensions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t, n, r)=>()=>(t !== null && (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Bundle cannot be an empty string`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(n, `Name cannot be empty`), {
            path: t ? `/extensions/${t}/${n}` : `/extensions/${n}`,
            params: {},
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/fields.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t, n, r, i)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Keys cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(n, `Field cannot be empty`), {
            path: `/fields/${t}/${n}`,
            params: i ?? {},
            body: JSON.stringify(r),
            method: `PATCH`
        }), n = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Collection cannot be empty`), {
            path: `/fields/${t}`,
            params: r ?? {},
            body: JSON.stringify(n),
            method: `PATCH`
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/files.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Keys cannot be empty`), {
            ...
            body: JSON.stringify(e),
            method: `PATCH`
        }), r = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Key cannot be empty`), n instanceof FormData ? {
            path: `/files/${t}`,
            params: r ?? {},
            body: n,
            method: `PATCH`,
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/flows.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/folders.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/items.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const n = (n, r, i, a)=>()=>{
        let o = {};
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use updateItems for core collections`), Array.isArray(r) ? ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(r, `keysOrQuery cannot be empty`), o = {
            keys: r
        }) : ((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(Object.keys(r), `keysOrQuery cannot be empty`), o = {
            query: r
        }), o.data = i, {
            path: `/items/${n}`,
            params: a ?? {},
    ...
    }, r = (n, r, i)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use updateItems for core collections`), {
            path: `/items/${n}`,
            params: i ?? {},
            body: JSON.stringify(r),
            method: `PATCH`
        }), i = (n, r, i, a)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(r), `Key cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use updateItem for core collections`), {
            path: `/items/${n}/${r}`,
            params: a ?? {},
            body: JSON.stringify(i),
            method: `PATCH`
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/notifications.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/operations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/panels.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/permissions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/policies.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/presets.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/relations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/roles.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/settings.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/shares.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/singleton.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const n = (n, r, i)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(n), `Collection cannot be empty`), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$core$2d$collection$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfCoreCollection"])(n, `Cannot use updateSingleton for core collections`), {
            path: `/items/${n}`,
            params: i ?? {},
            body: JSON.stringify(r),
            method: `PATCH`
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/translations.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/users.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/versions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/update/webhooks.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const t = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `Keys cannot be empty`), {
            ...
            method: `PATCH`
        }), n = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(String(t), `Key cannot be empty`), {
            path: `/webhooks/${t}`,
            params: r ?? {},
            body: JSON.stringify(n),
            method: `PATCH`
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/cache.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/export.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/flows.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/hash.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/import.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/shares.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/sort.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/users.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/versions.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/throw-if-empty.js [app-rsc] (ecmascript)");
;
const t = (t, n)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `ID cannot be empty`), {
            path: `/versions/${t}/save`,
            method: `POST`,
            body: JSON.stringify(n)
        }), n = (t)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `ID cannot be empty`), {
            path: `/versions/${t}/compare`,
            method: `GET`
        }), r = (t, n, r)=>()=>((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$throw$2d$if$2d$empty$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["throwIfEmpty"])(t, `ID cannot be empty`), {
            path: `/versions/${t}/promote`,
            method: `POST`,
            body: JSON.stringify(r ? {
                mainHash: n,
                fields: r
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/utils/random.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/composable.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const n = {}, r = (r = {})=>(i)=>{
        ...
        return {
            async request (n) {
                let o = n();
                if (o.headers ||= {}, `Content-Type` in o.headers ? o.headers[`Content-Type`] === `multipart/form-data` && delete o.headers[`Content-Type`] : o.headers[`Content-Type`] = `application/json`, `getToken` in this && !(`Authorization` in o.headers)) {
                    let e = await this.getToken();
                    e && (o.headers.Authorization = `Bearer ${e}`);
                }
                let s = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$get$2d$request$2d$url$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getRequestUrl"])(i.url, o.path, o.params), c = {
                    method: o.method ?? `GET`,
                    headers: o.headers ?? {}
                };
                `credentials` in a && (c.credentials = a.credentials), o.body && (c.body = o.body), o.onRequest && (c = await o.onRequest(c)), a.onRequest && (c = await a.onRequest(c));
                let l = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$request$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["request"])(s.toString(), c, i.globals.fetch);
                return `onResponse` in o && (l = await o.onResponse(l, c)), `onResponse` in r && (l = await r.onResponse(l, c)), l;
            }
        };
    };
;
...
"[project]/node_modules/@directus/sdk/dist/rest/helpers/with-options.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function e(e, t) {
    return ()=>{
        let n = e();
        return typeof t == `function` ? n.onRequest = t : n.onRequest = (e)=>({
                ...e,
                ...t
            }), n;
    };
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/read/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$activity$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/activity.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$aggregate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/aggregate.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$assets$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/assets.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$collections$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/collections.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$comments$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/comments.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$dashboards$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/dashboards.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$extensions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/extensions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$fields$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/fields.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$files$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/files.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$flows$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/flows.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$folders$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/folders.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$notifications$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/notifications.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$operations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/operations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$panels$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/panels.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$permissions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/permissions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$policies$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/policies.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$presets$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/presets.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$relations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/relations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$revisions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/revisions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$roles$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/roles.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$settings$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/settings.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$shares$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/shares.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$singleton$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/singleton.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$translations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/translations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$users$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/users.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$versions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/versions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$webhooks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/webhooks.js [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/node_modules/@directus/sdk/dist/rest/commands/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$login$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/login.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$logout$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/logout.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$password$2d$request$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/password-request.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$password$2d$reset$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/password-reset.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$providers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/providers.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$refresh$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/refresh.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$collections$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/collections.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$comments$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/comments.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$dashboards$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/dashboards.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$fields$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/fields.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$files$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/files.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$flows$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/flows.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$folders$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/folders.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$items$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/items.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$notifications$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/notifications.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$operations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/operations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$panels$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/panels.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$permissions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/permissions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$policies$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/policies.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$presets$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/presets.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$relations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/relations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$roles$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/roles.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$shares$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/shares.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$translations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/translations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$users$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/users.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$versions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/versions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$create$2f$webhooks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/create/webhooks.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$collections$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/collections.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$comments$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/comments.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$dashboards$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/dashboards.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$fields$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/fields.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$files$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/files.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$flows$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/flows.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$folders$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/folders.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$items$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/items.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$notifications$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/notifications.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$operations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/operations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$panels$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/panels.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$permissions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/permissions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$policies$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/policies.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$presets$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/presets.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$relations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/relations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$roles$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/roles.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$shares$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/shares.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$translations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/translations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$users$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/users.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$versions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/versions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$delete$2f$webhooks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/delete/webhooks.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$activity$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/activity.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$aggregate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/aggregate.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$assets$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/assets.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$collections$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/collections.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$versions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/versions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$webhooks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/webhooks.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$read$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/read/index.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$schema$2f$apply$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/schema/apply.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$schema$2f$diff$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/schema/diff.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$schema$2f$snapshot$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/schema/snapshot.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$server$2f$graphql$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/server/graphql.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$server$2f$health$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/server/health.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$server$2f$info$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/server/info.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$server$2f$openapi$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/server/openapi.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$server$2f$ping$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/server/ping.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$collections$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/collections.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$comments$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/comments.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$dashboards$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/dashboards.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$extensions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/extensions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$fields$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/fields.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$files$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/files.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$flows$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/flows.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$folders$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/folders.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$items$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/items.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$notifications$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/notifications.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$operations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/operations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$panels$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/panels.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$permissions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/permissions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$policies$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/policies.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$presets$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/presets.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$relations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/relations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$roles$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/roles.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$settings$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/settings.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$shares$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/shares.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$singleton$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/singleton.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$translations$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/translations.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$users$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/users.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$versions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/versions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$update$2f$webhooks$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/update/webhooks.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/cache.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$export$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/export.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$flows$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/flows.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$hash$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/hash.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$import$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/import.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$shares$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/shares.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$sort$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/sort.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$users$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/users.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$versions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/versions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$random$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/random.js [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/node_modules/@directus/sdk/dist/rest/helpers/with-token.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function e(e, t) {
    return ()=>{
        let n = t();
        return e && (n.headers ||= {}, n.headers.Authorization = `Bearer ${e}`), n;
    };
}
;
 //# sourceMappingURL=with-token.js.map
}),
"[project]/node_modules/@directus/sdk/dist/rest/helpers/custom-endpoint.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@directus/sdk/dist/rest/helpers/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$helpers$2f$with$2d$options$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/helpers/with-options.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$helpers$2f$with$2d$search$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/helpers/with-search.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$helpers$2f$with$2d$token$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/helpers/with-token.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$helpers$2f$custom$2d$endpoint$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/helpers/custom-endpoint.js [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/node_modules/@directus/sdk/dist/rest/index.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$versions$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/versions.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$utils$2f$random$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/utils/random.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/index.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$helpers$2f$with$2d$token$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/helpers/with-token.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$helpers$2f$custom$2d$endpoint$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/helpers/custom-endpoint.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$helpers$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/helpers/index.js [app-rsc] (ecmascript)");
;
;
;
;
...
"[project]/node_modules/@directus/sdk/dist/rest/helpers/with-search.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$query$2d$to$2d$params$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/utils/query-to-params.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/index.js [app-rsc] (ecmascript)");
;
;
function t(t) {
    return ()=>{
        let n = t();
        return n.method === `GET` && n.params && (n.method = `SEARCH`, n.body = JSON.stringify({
            query: {
                ...n.params,
                fields: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$utils$2f$query$2d$to$2d$params$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["formatFields"])(n.params.fields ?? [])
            }
        }), delete n.params), n;
    };
}
...
"[project]/node_modules/@directus/sdk/dist/utils/is-directus-error.js [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function e(e) {
    return typeof e == `object` && !!e && `errors` in e && Array.isArray(e.errors) && `message` in e.errors[0] && `extensions` in e.errors[0] && `code` in e.errors[0].extensions;
}
;
 //# sourceMappingURL=is-directus-error.js.map
}),
"[project]/node_modules/@directus/sdk/dist/index.js [app-rsc] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$auth$2f$composable$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/auth/composable.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$auth$2f$static$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/auth/static.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$auth$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/auth/index.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$graphql$2f$composable$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/graphql/composable.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$graphql$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/graphql/index.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$commands$2f$auth$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/commands/auth.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$commands$2f$pong$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/commands/pong.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$generate$2d$uid$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/utils/generate-uid.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$message$2d$callback$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/utils/message-callback.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$composable$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/composable.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$realtime$2f$utils$2f$sleep$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/realtime/utils/sleep.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$login$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/login.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$logout$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/logout.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$password$2d$request$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/password-request.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$commands$2f$auth$2f$password$2d$reset$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/commands/auth/password-reset.js [app-rsc] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$helpers$2f$custom$2d$endpoint$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/helpers/custom-endpoint.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$rest$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/rest/index.js [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$directus$2f$sdk$2f$dist$2f$utils$2f$is$2d$directus$2d$error$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@directus/sdk/dist/utils/is-directus-error.js [app-rsc] (ecmascript)");
;
;
;
;
...
const __TURBOPACK__page__$23$6__ = ()=>__turbopack_context__.r("[project]/app/actu/[slug]/page.tsx [app-rsc] (ecmascript, Next.js Server Component)");
;
;
;
;
                        ...
                        "children": [
                            ...
                            {},
                            {
                                ...
                                "page": [
                                    ...
                                    "[project]/app/actu/[slug]/page.tsx"
                                ]
                            }
                        ]
                    },
...
__turbopack_context__.s([
    ...
    "handler",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$app$2d$page$2e$js$3f$page$3d2f$actu$2f5b$slug$5d2f$page__$7b$__GLOBAL_ERROR_MODULE__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$global$2d$error$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__METADATA_0__$3d3e$__$225b$project$5d2f$app$2f$favicon$2e$ico$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$favicon$2e$ico__$28$static__in__ecmascript$2c$__tag__client$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_1__$3d3e$__$225b$project$5d2f$app$2f$layout$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_2__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$not$2d$found$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_3__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$forbidden$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_4__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$unauthorized$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_5__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$global$2d$error$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_6__$3d3e$__$225b$project$5d2f$app$2f$actu$2f5b$slug$5d2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["handler"],
    "patchFetch",
    ...
    "routeModule",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$app$2d$page$2e$js$3f$page$3d2f$actu$2f5b$slug$5d2f$page__$7b$__GLOBAL_ERROR_MODULE__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$global$2d$error$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__METADATA_0__$3d3e$__$225b$project$5d2f$app$2f$favicon$2e$ico$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$favicon$2e$ico__$28$static__in__ecmascript$2c$__tag__client$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_1__$3d3e$__$225b$project$5d2f$app$2f$layout$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_2__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$not$2d$found$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_3__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$forbidden$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_4__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$unauthorized$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_5__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$global$2d$error$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_6__$3d3e$__$225b$project$5d2f$app$2f$actu$2f5b$slug$5d2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["routeModule"],
    "serverHooks",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$build$2f$templates$2f$app$2d$page$2e$js$3f$page$3d2f$actu$2f5b$slug$5d2f$page__$7b$__GLOBAL_ERROR_MODULE__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$global$2d$error$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__METADATA_0__$3d3e$__$225b$project$5d2f$app$2f$favicon$2e$ico$2e$mjs__$7b$__IMAGE__$3d3e$__$5c225b$project$5d2f$app$2f$favicon$2e$ico__$28$static__in__ecmascript$2c$__tag__client$295c22$__$7d$__$5b$app$2d$rsc$5d$__$28$structured__image__object$2c$__ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_1__$3d3e$__$225b$project$5d2f$app$2f$layout$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_2__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$not$2d$found$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_3__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$forbidden$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_4__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$unauthorized$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_5__$3d3e$__$225b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$global$2d$error$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29222c$__MODULE_6__$3d3e$__$225b$project$5d2f$app$2f$actu$2f5b$slug$5d2f$page$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/node_modules/next/dist/esm/build/templates/app-page.js?page=/actu/[slug]/page { GLOBAL_ERROR_MODULE => "[project]/node_modules/next/dist/client/components/builtin/global-error.js [app-rsc] (ecmascript, Next.js Server Component)", METADATA_0 => "[project]/app/favicon.ico.mjs { IMAGE => \\"[project]/app/favicon.ico (static in ecmascript, tag client)\\" } [app-rsc] (structured image object, ecmascript, Next.js Server Component)", MODULE_1 => "[project]/app/layout.tsx [app-rsc] (ecmascript, Next.js Server Component)", MODULE_2 => "[project]/node_modules/next/dist/client/components/builtin/not-found.js [app-rsc] (ecmascript, Next.js Server Component)", MODULE_3 => "[project]/node_modules/next/dist/client/components/builtin/forbidden.js [app-rsc] (ecmascript, Next.js Server Component)", MODULE_4 => "[project]/node_modules/next/dist/client/components/builtin/unauthorized.js [app-rsc] (ecmascript, Next.js Server Component)", MODULE_5 => "[project]/node_modules/next/dist/client/components/builtin/global-error.js [app-rsc] (ecmascript, Next.js Server Component)", MODULE_6 => "[project]/app/actu/[slug]/page.tsx [app-rsc] (ecmascript, Next.js Server Component)" } [app-rsc] (ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$components$2f$builtin$2f$global$2d$error$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__Server__Component$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/client/components/builtin/global-error.js [app-rsc] (ecmascript, Next.js Server Component)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$app$2d$render$2f$entry$2d$base$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$2c$__Next$2e$js__server__utility$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/esm/server/app-render/entry-base.js [app-rsc] (ecmascript, Next.js server utility)");
}),
];

//# sourceMappingURL=node_modules_002dce49._.js.map